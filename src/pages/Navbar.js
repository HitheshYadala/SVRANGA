...
export default () => {
  return (
    ...
    <Navbar  bg="#f5fff2" expand="lg">
      <img style={{ marginLeft : '20px',width : '6%', height : '3%', marginRight : '20px',justifyContent:"space-evenly"}} src={logo}/> 
      <Navbar.Toggle aria-controls="basic-navbar-nav" />
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mr-auto">
        <Nav.Link  className={style.navglow} href="/">Home</Nav.Link>
    <Nav.Link className={style.navglow} href="/AboutUs">About Us</Nav.Link>



    <Nav.Link className={style.navglow} href="/Administration">Administration</Nav.Link>

    <NavDropdown className={style.navglow} title="Academics" id="basic-nav-dropdown">
    ...
    <Nav.Link className={style.navglow} href="/Welfare">Student's Welfare Activities</Nav.Link>
    <Nav.Link className={style.navglow} href="/Publications">Publications</Nav.Link>
    <Nav.Link  className={style.navglow} href="/ContactUs">Contact Us</Nav.Link>
        </Nav>
      </Navbar.Collapse>
    </Navbar>
  );
